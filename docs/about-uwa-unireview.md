...
- **Direct messaging** — contact other students whose reviews you found insightful
...
| Communication | AJAX (jQuery) for search/filter/votes, WebSockets for real-time messaging |
...
| 5 | Direct message | `/messages` | Two-panel chat interface. Left sidebar lists all conversations with preview of last message. Right panel shows full message thread with the selected student, anchored to the unit context that started the conversation. |
