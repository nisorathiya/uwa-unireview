...
| 5 | Student forum | `/messages` | Two-panel chat interface. Left sidebar lists all conversations with preview of last message. Right panel shows full message thread with the selected student, anchored to the unit context that started the conversation. |
